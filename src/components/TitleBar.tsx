    ...
    <div className="drag-region flex items-center justify-between h-11 px-4 flex-shrink-0 border-b border-mac-border transition-colors duration-150">
      ...
      <div className="flex items-center gap-1.5 no-drag">
        ...
        <button
          ...
          className="w-7 h-7 flex items-center justify-center rounded-md text-mac-text-tertiary hover:text-mac-text-secondary hover:bg-mac-overlay-strong transition-all"
          title="设置"
          aria-label="设置"
        >
